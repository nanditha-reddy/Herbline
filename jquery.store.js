(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.$paytmForm = this.$element.find( "#paytm-form" ); // Paytm form
			...
			this.paytmCurrency = "RS"; // Paytm's currency code
			this.paytmBusinessEmail = "yourbusiness@email.com"; // Your Business paytm's account email address
			this.paytmURL = "https://www.paytm.com/cgi-bin/webscr"; // The URL of the Paytm's form
		...
		// Appends the required hidden values to the Paytm's form before submitting
		
		populatePaytmForm: function() {
			var self = this;
			if( self.$paytmForm.length ) {
				var $form = self.$paytmForm;
				...
				$form.attr( "action", self.paytmURL );
				$form.find( "input[name='business']" ).val( self.paytmBusinessEmail );
				$form.find( "input[name='currency_code']" ).val( self.paytmCurrency );
